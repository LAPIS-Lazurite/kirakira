...
;; File Name       : driver_flash.c
	...
	type (ML620504F) 
	model small, near
	$$flash_erase$driver_flash segment code 2h #0h
	$$flash_read$driver_flash segment code 2h #0h
	$$flash_read_byte$driver_flash segment code 2h #0h
	$$flash_write$driver_flash segment code 2h #0h
	$$flash_write_byte$driver_flash segment code 2h #0h
CVERSION 3.53.1
CGLOBAL 01H 02H 0000H "flash_read" 08H 02H 41H 01H 80H 02H 00H 00H 08H
CGLOBAL 01H 03H 0000H "flash_erase" 08H 02H 43H 01H 81H 04H 00H 00H 07H
CGLOBAL 01H 02H 0000H "flash_read_byte" 08H 02H 42H 01H 80H 02H 00H 00H 00H
CGLOBAL 01H 03H 0000H "flash_write_byte" 08H 02H 3FH 01H 81H 08H 00H 00H 07H
CGLOBAL 01H 03H 0000H "flash_write" 08H 02H 3EH 01H 83H 08H 00H 00H 07H
...
CFILE 0005H 0000003EH "C:\\Users\\chiya\\Desktop\\LAZURI~1\\hardware\\LAZURI~2\\lazurite\\lazurite.h"
...
CFILE 001BH 00000028H "C:\\Users\\chiya\\Desktop\\LAZURI~1\\hardware\\lazurite_subghz\\ml620q504\\driver_gpio.h"
CFILE 001CH 00000025H "C:\\Users\\chiya\\Desktop\\LAZURI~1\\hardware\\lazurite_subghz\\ml620q504\\driver_adc.h"
CFILE 001DH 00000028H "C:\\Users\\chiya\\Desktop\\LAZURI~1\\hardware\\lazurite_subghz\\ml620q504\\driver_pin_assignment.h"
CFILE 001EH 00000045H "C:\\Users\\chiya\\Desktop\\LAZURI~1\\hardware\\LAZURI~2\\ML620Q~1\\common\\rdwr_reg.h"
CFILE 001FH 00000040H "C:\\Users\\chiya\\Desktop\\LAZURI~1\\hardware\\LAZURI~2\\ML620Q~1\\wdt\\wdt.h"
CFILE 0020H 0000006FH "C:\\Users\\chiya\\Desktop\\LAZURI~1\\hardware\\lazurite_subghz\\ml620q504\\driver_irq.h"
CFILE 0021H 00000331H "C:\\Users\\chiya\\Desktop\\LAZURI~1\\hardware\\LAZURI~2\\ML620Q~1\\irq\\irq.h"
CFILE 0000H 0000008EH "C:\\Users\\chiya\\Desktop\\LAZURI~1\\hardware\\lazurite_subghz\\ml620q504\\driver_flash.c"

	rseg $$flash_write$driver_flash
CFUNCTION 318
...
;;{
CLINEA 0000H 0001H 0021H 0001H 0001H
;;*****************************************
...
;;	wdt_clear();
CLINEA 0000H 0001H 0022H 0002H 000DH
	bl	_wdt_clear

;;	dis_interrupts(DI_DFLASH);
CLINEA 0000H 0001H 0023H 0002H 001BH
	mov	r0,	#00h
	mov	r1,	#01h
	bl	_dis_interrupts

;;	set_bit(FSELF);
CLINEA 0000H 0001H 0025H 0002H 0010H
	sb	0f0eah.0

;;	write_reg8( FLASHACP, 0xFA );
CLINEA 0000H 0001H 0026H 0002H 001EH
	mov	r0,	#0fah
	st	r0,	0f0e6h

;;	write_reg8( FLASHACP, 0xF5 );
CLINEA 0000H 0001H 0027H 0002H 001EH
	mov	r0,	#0f5h
	st	r0,	0f0e6h

;;	write_reg8( FLASHSEG, 7 );
CLINEA 0000H 0001H 0028H 0002H 001BH
	mov	r0,	#07h
	st	r0,	0f0e8h

;;	if(sector != 0) address += 0x400;
CLINEA 0000H 0001H 0029H 0002H 0022H
	cmp	r8,	#00h
	beq	_$L1
	add	r10,	#00h
	addc	r11,	#04h
...
CLINEA 0000H 0001H 002AH 0002H 0020H
	st	er10,	0f0e0h

;;	write_reg16( FLASHD, data );
CLINEA 0000H 0001H 002BH 0002H 001DH
	l	er0,	_data$4[fp]
	st	er0,	0f0e2h

;;	__asm("nop");
CLINEA 0000H 0001H 002CH 0002H 000EH
nop

;;	__asm("nop");
CLINEA 0000H 0001H 002DH 0002H 000EH
nop

;;	clear_bit(FSELF);
CLINEA 0000H 0001H 002EH 0002H 0012H
	rb	0f0eah.0

;;	enb_interrupts(DI_DFLASH);
CLINEA 0000H 0001H 0030H 0002H 001BH
	mov	r0,	#00h
	mov	r1,	#01h
	bl	_enb_interrupts
CBLOCKEND 318 2 50
...
CFUNCTIONEND 318
	...
	rseg $$flash_write_byte$driver_flash
CFUNCTION 319
...
CARGUMENT 46H 0001H 001CH "sector" 02H 00H 00H
CARGUMENT 46H 0002H 0029H "address" 02H 00H 01H
CARGUMENT 42H 0001H 0002H "data" 02H 00H 00H
CLOCAL 46H 0002H 0025H 0002H "tmp_data" 02H 00H 08H
CLOCAL 46H 0002H 0026H 0002H "tmp_addr" 02H 00H 08H

;;	unsigned short tmp_addr = address&~(0x0001);
CLINEA 0000H 0001H 0037H 0002H 002DH
	mov	er0,	er2
	and	r0,	#0feh
	mov	er4,	er0	;; _ltmp_addr$2

;;	wdt_clear();
CLINEA 0000H 0001H 0039H 0002H 000DH
	bl	_wdt_clear

;;	dis_interrupts(DI_DFLASH);
CLINEA 0000H 0001H 003AH 0002H 001BH
	mov	r0,	#00h
	mov	r1,	#01h
	bl	_dis_interrupts

;;	tmp_data = flash_read(sector, address&0xFE);
CLINEA 0000H 0000H 003CH 0002H 002DH
	mov	er2,	er10
	and	r2,	#0feh
	and	r3,	#00h
	mov	r0,	r8
	mov	r1,	#00h
	bl	_flash_read
	mov	er2,	er0	;; _ltmp_data$0

;;	if(tmp_addr&0x0001)
CLINEA 0000H 0001H 003DH 0002H 0014H
	tb	r4.0
	beq	_$L4
CBLOCK 319 3 62

;;		tmp_data <<= 8;
CLINEA 0000H 0001H 003FH 0003H 0011H
	mov	r1,	r2
	mov	r0,	#00h

;;		tmp_data |= 0x00FF;
CLINEA 0000H 0001H 0040H 0003H 0015H
	or	r0,	#0ffh
CBLOCKEND 319 3 65

;;	else
CLINEA 0000H 0001H 0042H 0002H 0005H
	bal	_$L6
_$L4 :
CBLOCK 319 4 67

;;		tmp_data |= 0xFF00;
CLINEA 0000H 0001H 0044H 0003H 0015H
	or	r1,	#0ffh
CBLOCKEND 319 4 69
...
;;	set_bit(FSELF);
CLINEA 0000H 0001H 0046H 0002H 0010H
	sb	0f0eah.0

;;	write_reg8( FLASHACP, 0xFA );
CLINEA 0000H 0001H 0047H 0002H 001EH
	mov	r0,	#0fah
	st	r0,	0f0e6h

;;	write_reg8( FLASHACP, 0xF5 );
CLINEA 0000H 0001H 0048H 0002H 001EH
	mov	r0,	#0f5h
	st	r0,	0f0e6h

;;	write_reg8( FLASHSEG, 7 );
CLINEA 0000H 0001H 0049H 0002H 001BH
	mov	r0,	#07h
	st	r0,	0f0e8h

;;	write_reg16( FLASHA, tmp_addr );
CLINEA 0000H 0001H 004BH 0002H 0021H
	st	er4,	0f0e0h

;;	write_reg16( FLASHD, tmp_data );
CLINEA 0000H 0001H 004CH 0002H 0021H
	st	er2,	0f0e2h

;;	__asm("nop");
CLINEA 0000H 0001H 004DH 0002H 000EH
nop

;;	__asm("nop");
CLINEA 0000H 0001H 004EH 0002H 000EH
nop
...
;;	enb_interrupts(DI_DFLASH);
CLINEA 0000H 0001H 0051H 0002H 001BH
	mov	r0,	#00h
	mov	r1,	#01h
	bl	_enb_interrupts
CBLOCKEND 319 2 82
...
;;*****************************************
	...
	push	er6
CBLOCK 321 2 86
CARGUMENT 46H 0001H 0014H "sector" 02H 00H 00H
CARGUMENT 46H 0002H 0025H "address" 02H 00H 01H
CLOCAL 66H 0003H 1624H 0002H "far_addr" 04H 03H 00H 00H 08H
CLOCAL 46H 0004H 2726H 0002H "laddr" 02H 00H 02H

;;	if(sector == 0)	laddr = 0x000F0000 + address;
CLINEA 0000H 0001H 005AH 0002H 002EH
	cmp	r0,	#00h
	bne	_$L10
	mov	er0,	er2
	mov	er2,	#0 
...
CLINEA 0000H 0001H 005BH 0002H 0025H
	bal	_$L12
_$L10 :
	mov	er0,	er2
	mov	er2,	#0 
...
_$L12 :
	addc	r2,	#0fh
	addc	r3,	#00h
	mov	er6,	er2	;; _lladdr$4

;;	far_addr = (unsigned short __far *)laddr;
CLINEA 0000H 0001H 005DH 0002H 002AH

;;	return *far_addr;
CLINEA 0000H 0001H 005EH 0002H 0012H
	l	er0,	r6:[er0]
CBLOCKEND 321 2 95
...
CFUNCTIONEND 321
	...
	rseg $$flash_read_byte$driver_flash
CFUNCTION 322
...
CARGUMENT 46H 0001H 0014H "sector" 02H 00H 00H
CARGUMENT 46H 0002H 0025H "address" 02H 00H 01H
CLOCAL 66H 0003H 1624H 0002H "far_addr" 04H 03H 00H 00H 00H
CLOCAL 46H 0004H 2726H 0002H "laddr" 02H 00H 02H

;;	if(sector == 0)	laddr = 0x000F0000 + address;
CLINEA 0000H 0001H 0066H 0002H 002EH
	cmp	r0,	#00h
	bne	_$L14
	mov	er0,	er2
	mov	er2,	#0 
...
;;	else			laddr = 0x000F0400 + address;
CLINEA 0000H 0001H 0067H 0002H 0025H
	bal	_$L16
_$L14 :
	mov	er0,	er2
	mov	er2,	#0 
...
CLINEA 0000H 0001H 0069H 0002H 0029H

;;	return *far_addr;
CLINEA 0000H 0001H 006AH 0002H 0012H
	l	r0,	r6:[er0]
CBLOCKEND 322 2 107

;;}
CLINEA 0000H 0000H 006BH 0001H 0001H
	pop	er6
	rt
CBLOCKEND 322 1 107
CFUNCTIONEND 322
...
;;	wdt_clear();
CLINEA 0000H 0001H 006FH 0002H 000DH
	bl	_wdt_clear
...
;;	set_bit(FSELF);
CLINEA 0000H 0001H 0072H 0002H 0010H
	sb	0f0eah.0

;;	switch(sector)
CLINEA 0000H 0001H 0073H 0002H 000FH
CBLOCK 323 3 116
	cmp	r8,	#00h
	beq	_$L23

;;	switch(sector)
CLINEA 0000H 0000H 0073H 0002H 000FH
	cmp	r8,	#01h
	beq	_$L24
...
;;	clear_bit(FSELF);
CLINEA 0000H 0001H 008AH 0002H 0012H
	rb	0f0eah.0
...
;;	case 0:
CLINEA 0000H 0001H 0075H 0002H 0008H
_$L23 :

;;		write_reg8( FLASHACP, 0xFA );
CLINEA 0000H 0001H 0077H 0003H 001FH
	mov	r0,	#0fah
	st	r0,	0f0e6h

;;		write_reg8( FLASHACP, 0xF5 );
CLINEA 0000H 0001H 0078H 0003H 001FH
	mov	r0,	#0f5h
	st	r0,	0f0e6h

;;		write_reg8( FLASHSEG, 7);
CLINEA 0000H 0001H 0079H 0003H 001BH
	mov	r0,	#07h
	st	r0,	0f0e8h

;;		write_reg8( FLASHAH, 0);
CLINEA 0000H 0001H 007AH 0003H 001AH
	mov	r0,	#00h
	st	r0,	0f0e1h

;;		set_bit( FSERS );
CLINEA 0000H 0001H 007BH 0003H 0013H
	sb	0f0e4h.1

;;		__asm("nop");
CLINEA 0000H 0001H 007CH 0003H 000FH
nop

;;		__asm("nop");
CLINEA 0000H 0001H 007DH 0003H 000FH
nop

;;		break;
CLINEA 0000H 0001H 007EH 0003H 0008H
	bal	_$L21

;;	case 1:
CLINEA 0000H 0001H 007FH 0002H 0008H
_$L24 :

;;		write_reg8( FLASHACP, 0xFA );
CLINEA 0000H 0001H 0081H 0003H 001FH
	mov	r0,	#0fah
	st	r0,	0f0e6h

;;		write_reg8( FLASHACP, 0xF5 );
CLINEA 0000H 0001H 0082H 0003H 001FH
	mov	r0,	#0f5h
	st	r0,	0f0e6h

;;		write_reg8( FLASHSEG, 7);
CLINEA 0000H 0001H 0083H 0003H 001BH
	mov	r0,	#07h
	st	r0,	0f0e8h

;;		write_reg8( FLASHAH, 4);
CLINEA 0000H 0001H 0084H 0003H 001AH
	mov	r0,	#04h
	st	r0,	0f0e1h

;;		set_bit( FSERS );
CLINEA 0000H 0001H 0085H 0003H 0013H
	sb	0f0e4h.1
...
;;		break;
CLINEA 0000H 0001H 0088H 0003H 0008H
	bal	_$L21
CBLOCKEND 323 3 137
CBLOCKEND 323 1 141
CFUNCTIONEND 323
	...
	public _flash_read
	public _flash_erase
	public _flash_read_byte
	public _flash_write_byte
	public _flash_write
