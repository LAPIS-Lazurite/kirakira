...
;; File Name       : wiring_shift.c
	...
	type (ML620504F) 
	model small, near
	$$shiftIn$wiring_shift segment code 2h #0h
	$$shiftOut$wiring_shift segment code 2h #0h
CVERSION 3.53.1
CGLOBAL 01H 02H 0000H "shiftIn" 08H 02H 72H 00H 81H 08H 00H 00H 00H
CGLOBAL 01H 03H 0000H "shiftOut" 08H 02H 73H 00H 81H 08H 00H 00H 07H
...
CFILE 0005H 0000003EH "C:\\Users\\chiya\\Desktop\\LAZURI~1\\hardware\\lazurite_subghz\\lazurite\\lazurite.h"
CFILE 0006H 0000002BH "C:\\Users\\chiya\\Desktop\\LAZURI~1\\hardware\\lazurite_subghz\\lazurite\\analogio.h"
...
CFILE 0000H 00000058H "C:\\Users\\chiya\\Desktop\\LAZURI~1\\hardware\\lazurite_subghz\\lazurite\\wiring_shift.c"

	rseg $$shiftIn$wiring_shift
CFUNCTION 114
...
CBLOCK 114 2 46
CRET 0006H
CARGUMENT 46H 0001H 001CH "dataPin" 02H 00H 00H
CARGUMENT 46H 0001H 001DH "clockPin" 02H 00H 00H
CARGUMENT 46H 0001H 001EH "bitOrder" 02H 00H 00H
CLOCAL 46H 0001H 0019H 0002H "value" 02H 00H 00H
CLOCAL 46H 0001H 0018H 0002H "i" 02H 00H 00H

;;	UCHAR value = 0;
CLINEA 0000H 0001H 002FH 0002H 0011H
	mov	r5,	#00h	;; _lvalue$0
...
CLINEA 0000H 0001H 0033H 0003H 001FH
	mov	r1,	#01h
	mov	r0,	r9
	bl	_digitalWrite

;;		if(bitOrder == LSBFIRST)
CLINEA 0000H 0001H 0034H 0003H 001AH
	cmp	r10,	#00h
	bne	_$L7
CBLOCK 114 4 53

;;			value >>= 1;
CLINEA 0000H 0001H 0036H 0004H 000FH
	srl	r5,	#01h

;;			value |= (digitalRead(dataPin) << 7);
CLINEA 0000H 0001H 0037H 0004H 0028H
	mov	r0,	r8
	bl	_digitalRead
	sll	r0,	#07h
	or	r5,	r0
...
;;		else
CLINEA 0000H 0001H 0039H 0003H 0006H
	bal	_$L9
_$L7 :
CBLOCK 114 5 58

;;			value <<= 1;
CLINEA 0000H 0001H 003BH 0004H 000FH
	sll	r5,	#01h

;;			value |= digitalRead(dataPin);
CLINEA 0000H 0001H 003CH 0004H 0021H
	mov	r0,	r8
	bl	_digitalRead
	or	r5,	r0
CBLOCKEND 114 5 61
...
;;		}
CLINEA 0000H 0000H 003DH 0003H 0003H
_$L9 :

;;		digitalWrite(clockPin, LOW);
CLINEA 0000H 0001H 003EH 0003H 001EH
	mov	r1,	#00h
	mov	r0,	r9
	bl	_digitalWrite
CBLOCKEND 114 3 63
...
;;	for(i = 0; i < 8 ; i++)
CLINEA 0000H 0000H 0031H 0002H 0018H
	add	r4,	#01h
	cmp	r4,	#08h
	blt	_$L3

;;	return value;
CLINEA 0000H 0001H 0040H 0002H 000EH
	mov	r0,	r5
CBLOCKEND 114 2 65

;;}
CLINEA 0000H 0000H 0041H 0001H 0001H
	pop	er4
	pop	xr8
	pop	pc
CBLOCKEND 114 1 65
...
CARGUMENT 46H 0001H 001DH "clockPin" 02H 00H 00H
CARGUMENT 46H 0001H 001EH "bitOrder" 02H 00H 00H
CARGUMENT 46H 0001H 001FH "val" 02H 00H 00H
CLOCAL 46H 0001H 0018H 0002H "i" 02H 00H 00H

;;	for (i = 0; i < 8; i++)  {
CLINEA 0000H 0001H 0047H 0002H 001BH
	mov	r4,	#00h	;; _li$0
_$L13 :
CBLOCK 115 3 71

;;		if (bitOrder == LSBFIRST)
CLINEA 0000H 0001H 0048H 0003H 001BH
	cmp	r10,	#00h
	bne	_$L17
CBLOCK 115 4 73

;;			digitalWrite(dataPin,(unsigned char)(val & 0x01));
CLINEA 0000H 0001H 004AH 0004H 0035H
	mov	r1,	r11
	and	r1,	#01h
	mov	r0,	r8
	bl	_digitalWrite
...
;;			val >>= 1;
CLINEA 0000H 0001H 004BH 0004H 000DH
	srl	r11,	#01h
CBLOCKEND 115 4 76

;;		else
CLINEA 0000H 0001H 004DH 0003H 0006H
	bal	_$L19
_$L17 :
CBLOCK 115 5 78

;;			digitalWrite(dataPin, (val >= 0x80));
CLINEA 0000H 0001H 004FH 0004H 0028H
	mov	r1,	#080h
	cmp	r11,	#080h
	subc	r1,	r1
	add	r1,	#01h
...
;;			val <<= 1;
CLINEA 0000H 0001H 0050H 0004H 000DH
	sll	r11,	#01h
CBLOCKEND 115 5 81

;;		}
CLINEA 0000H 0000H 0051H 0003H 0003H
_$L19 :

;;		digitalWrite(clockPin, HIGH);
CLINEA 0000H 0001H 0052H 0003H 001FH
	mov	r1,	#01h
	mov	r0,	r9
	bl	_digitalWrite

;;		digitalWrite(clockPin, LOW);
CLINEA 0000H 0001H 0053H 0003H 001EH
	mov	r1,	#00h
	mov	r0,	r9
	bl	_digitalWrite
CBLOCKEND 115 3 84
...
;;	for (i = 0; i < 8; i++)  {
CLINEA 0000H 0000H 0047H 0002H 001BH
	add	r4,	#01h
	cmp	r4,	#08h
	blt	_$L13
CBLOCKEND 115 2 87
