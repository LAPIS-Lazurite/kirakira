...
;; File Name       : digitalio.c
	...
	type (ML620504F) 
	model small, near
	$$TABdigital_pin_to_port$digitalio segment table 2h #0h
	$$digitalRead$digitalio segment code 2h #0h
	$$digitalWrite$digitalio segment code 2h #0h
	$$pinMode$digitalio segment code 2h #0h
CVERSION 3.53.1
CGLOBAL 01H 03H 0000H "digitalWrite" 08H 02H 49H 00H 80H 00H 00H 00H 07H
CGLOBAL 01H 03H 0000H "digitalRead" 08H 02H 48H 00H 80H 00H 00H 00H 01H
CGLOBAL 01H 03H 0000H "pinMode" 08H 02H 47H 00H 80H 00H 00H 00H 07H
...
CGLOBAL 01H 00H 0024H "digital_pin_to_port" 05H 01H 24H 00H 00H 00H
...
CFILE 001BH 00000028H "C:\\Users\\chiya\\Desktop\\LAZURI~1\\hardware\\LAZURI~2\\ML620Q~1\\driver_gpio.h"
CFILE 0000H 00000066H "C:\\Users\\chiya\\Desktop\\LAZURI~1\\hardware\\lazurite_subghz\\lazurite\\digitalio.c"

	rseg $$pinMode$digitalio
CFUNCTION 71
...
CARGUMENT 46H 0001H 0015H "mode" 02H 00H 00H

;;	if(pin > MAX_PIN_NO) return;
CLINEA 0000H 0001H 0053H 0002H 001DH
	cmp	r0,	#023h
	ble	_$L1
CBLOCKEND 71 2 86
...
;;	if(pin > MAX_PIN_NO) return;
CLINEA 0000H 0000H 0053H 0002H 001DH
_$L1 :

;;	drv_pinMode(digital_pin_to_port[pin], mode);
CLINEA 0000H 0001H 0054H 0002H 002DH
	mov	r2,	r0
	mov	r3,	#00h
	l	r0,	NEAR _digital_pin_to_port[er2]
	b	_drv_pinMode
CLINEA 0000H 0001H 0055H 0002H 0008H
CBLOCKEND 71 1 86
CFUNCTIONEND 71


	rseg $$digitalRead$digitalio
CFUNCTION 72
...
CLINEA 0000H 0001H 005AH 0002H 0022H
	cmp	r0,	#023h
	ble	_$L4
	mov	er0,	#0 
CBLOCKEND 72 2 92
...
;;	if(pin > MAX_PIN_NO) return(LOW);
CLINEA 0000H 0000H 005AH 0002H 0022H
_$L4 :

;;	return drv_digitalRead(digital_pin_to_port[pin]);
CLINEA 0000H 0001H 005BH 0002H 0032H
	mov	r1,	#00h
...
CBLOCK 73 2 95
CARGUMENT 46H 0001H 0014H "pin" 02H 00H 00H
CARGUMENT 46H 0001H 0015H "val" 02H 00H 00H
...
;;	if(pin > MAX_PIN_NO) return;
CLINEA 0000H 0000H 0060H 0002H 001DH
_$L7 :

;;	drv_digitalWrite(digital_pin_to_port[pin], val);
CLINEA 0000H 0001H 0061H 0002H 0031H
	mov	r2,	r0
	mov	r3,	#00h
	l	r0,	NEAR _digital_pin_to_port[er2]
	b	_drv_digitalWrite
CLINEA 0000H 0001H 0062H 0002H 0008H
CBLOCKEND 73 1 99
CFUNCTIONEND 73

	public _digitalWrite
	public _digitalRead
	public _pinMode
	public _digital_pin_to_port
	extrn code near : _drv_digitalWrite
	extrn code near : _drv_pinMode
	extrn code near : _drv_digitalRead
	extrn code near : _main

	rseg $$TABdigital_pin_to_port$digitalio
_digital_pin_to_port :
	db	0ch
	db	0dh
	db	01ch
	db	01fh
