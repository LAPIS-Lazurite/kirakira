...
;; File Name       : WInterrupts.c
	...
	type (ML620504F) 
	model small, near
	$$attachInterrupt$WInterrupts segment code 2h #0h
	$$detachInterrupt$WInterrupts segment code 2h #0h
CVERSION 3.53.1
CGLOBAL 01H 03H 0000H "attachInterrupt" 08H 02H 76H 00H 83H 10H 00H 00H 07H
CGLOBAL 01H 03H 0000H "detachInterrupt" 08H 02H 77H 00H 80H 00H 00H 00H 07H
...
CFILE 001BH 00000026H "C:\\Users\\chiya\\Desktop\\LAZURI~1\\hardware\\LAZURI~2\\ML620Q~1\\driver_extirq.h"
CFILE 001CH 0000002DH "C:\\Users\\chiya\\Desktop\\LAZURI~1\\hardware\\lazurite_subghz\\lazurite\\Winterrupts.h"
CFILE 0000H 00000046H "C:\\Users\\chiya\\Desktop\\LAZURI~1\\hardware\\lazurite_subghz\\lazurite\\WInterrupts.c"

	rseg $$attachInterrupt$WInterrupts
CFUNCTION 118
...
CARGUMENT 47H 0002H 0029H "func" 0AH 03H 00H 02H 2DH 01H 00H 00H 00H 00H 07H
CARGUMENT 43H 0002H 0004H "mode" 02H 00H 01H
CLOCAL 46H 0001H 0018H 0002H "pin" 02H 00H 00H

;;	if(irqnum > 1) return;
CLINEA 0000H 0001H 0031H 0002H 0017H
	cmp	r0,	#01h
	ble	_$L1
CBLOCKEND 118 2 59
...
;;	if(irqnum > 1) return;
CLINEA 0000H 0000H 0031H 0002H 0017H
_$L1 :

;;	if(irqnum == 0) pin = 2;
CLINEA 0000H 0001H 0033H 0002H 0019H
	cmp	r0,	#00h
	bne	_$L3
	mov	r0,	#02h

;;	else pin = 3;
CLINEA 0000H 0001H 0034H 0002H 000EH
	bal	_$L5
_$L3 :
	mov	r0,	#03h
_$L5 :
...
;;	if(func == NULL) return;
CLINEA 0000H 0001H 0036H 0002H 0019H
	mov	er10,	er10
	beq	_$L0

;;	drv_attachInterrupt(digital_pin_to_port[pin], irqnum, func, mode,false,false);
CLINEA 0000H 0001H 0039H 0002H 004FH
	mov	r0,	#00h
	push	r0
	push	r0
	l	er0,	_mode$4[fp]
	...
	mov	r1,	r8
	mov	r5,	#00h
	l	r0,	NEAR _digital_pin_to_port[er4]
	bl	_drv_attachInterrupt
	add	sp,	#6 

;;	return;
CLINEA 0000H 0001H 003AH 0002H 0008H
	bal	_$L0
CBLOCKEND 118 1 59
CFUNCTIONEND 118


	rseg $$detachInterrupt$WInterrupts
CFUNCTION 119
...
CBLOCK 119 2 62
CARGUMENT 46H 0001H 0014H "irqnum" 02H 00H 00H

;;	if(irqnum > 1) return;
CLINEA 0000H 0001H 003FH 0002H 0017H
	cmp	r0,	#01h
	ble	_$L9
CBLOCKEND 119 2 68
...
;;	if(irqnum > 1) return;
CLINEA 0000H 0000H 003FH 0002H 0017H
_$L9 :

;;	drv_detachInterrupt(irqnum);
CLINEA 0000H 0001H 0041H 0002H 001DH
	b	_drv_detachInterrupt
CLINEA 0000H 0001H 0043H 0002H 0008H
CBLOCKEND 119 1 68
CFUNCTIONEND 119

	public _attachInterrupt
	public _detachInterrupt
